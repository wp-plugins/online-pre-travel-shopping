...
<div class="sf_box sf_<?php echo $themes; ?>" style="border-color:<?php echo $border_color; ?>; background:<?php echo $background_color; ?>; width:<?php if($themes == 'dynamic-width'){ echo $custom_width;} ?>px;">
    <h3 style="color:<?php echo $text_color; ?>;font-size:32px;">
       <?php echo __('Shop the world');?>
        <span style="color:<?php echo $text_color; ?>;"><?php echo __('before you leave home!');?></span> 
    </h3>
    <div class="sf_form_container">
        <form id="sf_formr" class="sf_form" name="sf_formr" method="post">
            <div class="sf_form_body">
                <p>
                    <label style="color:<?php echo $text_color; ?>;"><?php echo _e('What would you like to buy?');?></label>
                ...
                <p>
                    <span class="sf_from">
                        <label style="color:<?php echo $text_color; ?>;"><?php echo _e('From');?></label>
                    ...
                    <span class="sf_to">
                        <label style="color:<?php echo $text_color; ?>;"><?php echo _e('To');?></label>
            ...
            <div class="sf_form_footer">
                ...
                <ul class="sf_steps" style="color:<?php echo $text_color; ?>;display:<?php if($custom_width<400){echo ('none');}?>;">
                    <li class="sf_step_shop" style="color:<?php echo $text_color; ?>;"><i class="icon-shop"></i><span style=" background:<?php echo $background_color; ?>;"><?php echo _e('Shop');?></span></li>
                    <li class="sf_step_collect" style="color:<?php echo $text_color; ?>;"><i class="icon-collect"></i><span style=" background:<?php echo $background_color; ?>;"><?php echo _e('Collect');?></span></li>
                    <li class="sf_step_fly" style="color:<?php echo $text_color; ?>;"><i class="icon-fly"></i><span style=" background:<?php echo $background_color; ?>;"><?php echo _e('Fly');?></span></li>
                </ul>
                <br>
                <span style="color:<?php echo $text_color; ?>;font-size:12px;font-family: 'Helvetica-Neue-Light', Arial;top:5px;"><a href="https://shopnfly.com" style="color:<?php echo $text_color; ?>;" title="Pre-travel shopping" target="_blank"><?php echo _e('Pre-travel shopping');?></a><?php if($themes == 'narrow' || $themes =='wide'){ echo "<br>" ;}?><?php echo _e(' by shopnfly');?></span>
            </div>
        </form>                        
    </div>
</div>
